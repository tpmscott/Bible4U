...
//      var bcsname2 = bname + ' 第' + cname + '篇' + ' 第' + sname + '節' + '</ol>';
      ...
      //var bcsname1 = bname + ' 第' + cname + '章' + '</ol>';   // Marked on 2017.01.07
      //var bcsname2 = bname + ' 第' + cname + '篇' + '</ol>';   // Marked on 2017.01.07

      var bcsname1 = bname + ' 第' + cname + '章' + ' 第' + sname + '節' + ' 已被儲存進讀經進度' + rnum + '</ol>';
      var bcsname2 = bname + ' 第' + cname + '篇' + ' 第' + sname + '節' + ' 已被儲存進讀經進度' + rnum + '</ol>';
...
function readchapter(bnum, cnum ,snum) {   // for window3, main.html
  ...
  //document.getElementById("p1").innerHTML = "New text!"; // for test
...
//      var oneline_1_3 = '<table><tr><td valign="top">'+'NIV'+'&nbsp&nbsp&nbsp&nbsp'+'</td><td valign="top">'+sj+'</td><td>'+oneline_3+'</td></tr></table>';
      ...
      if(cname==cname_1){
         ...
         //if(parent.command.document.BV.BibleVersion[3].checked){   // 先不執行
         ...
         //else{
            ...
            if(BibleVersion_Disp==3){        // 和合本 & 呂振中譯本
...
function noMatch() {
  ...
  '<meta http-equiv="Content-Type" content="text/html; charset=big5">\n</HEAD>' +
    '<BODY BGCOLOR=WHITE TEXT=BLACK background="back5.jpg">');
         ...
         var Result_head1 = '<center><p2>&nbsp&nbsp&nbsp</p2>';
         var Result_head2 = '<p4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp~查詢結果~&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p4>';
         var Result_head3 = '<p2><a href="" onClick="Send_to_win34(4,0,0,0,0,0,0); return false;">縮小</a></p2></center>';
         //var Result_head = Result_head1 + Result_head2 + Result_head3;
         var Result_head = Result_head1 + Result_head2;
         var Result_line = '<HR NOSHADE WIDTH=95%>';
         var Result_end = '<center><p4> 無符合之資料 </p4></center><p4>';
         

         docObj.writeln(Result_head.fontcolor(bcs_color));
         docObj.writeln(Result_line.fontcolor(bcs_color));
         docObj.writeln(Result_end.fontcolor(bcs_color));
...
// Define a function that show help information
// like how to Zoom In, Zoom Out .etc
function Show_Help() {
  ...
  '<meta http-equiv="Content-Type" content="text/html; charset=big5">\n</HEAD>' +
    '<BODY BGCOLOR=WHITE TEXT=BLACK background="back5.jpg">');
         ...
         var Result_head1 = '<center><p2>&nbsp&nbsp&nbsp</p2>';
         var Result_head2 = '<p4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp~使用說明~&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p4>';
         var Result_head3 = '<p2><a href="" onClick="Send_to_win34(4,0,0,0,0,0,0); return false;">縮小</a></p2></center>';
         var Result_head = Result_head1 + Result_head2 + Result_head3;
         var Result_line = '<HR NOSHADE WIDTH=95%>';
         var Help_Info1 = '<center><p4>&nbsp  </p4></center><center><p4>&nbsp可用Zoom In、Zoom Out調整視窗中字型大小  </p4></center>';
         var Help_Info2 = '<center><p4>&nbsp  </p4></center>';
         var Help_Info3 = '<center><p4>  Zoom In&nbsp:  Press Ctrl+Shift+=  </p4></center>';
         var Help_Info4 = '<center><p4>  Zoom Out&nbsp: Press Ctrl+- &nbsp&nbsp&nbsp&nbsp</p4></center>';
         var Help_Info5 = '<center><p4>  Actual Size&nbsp: Press Ctrl+0 &nbsp</p4></center>';
         var Help_Info6a = '<center><p4>  Show Window (small)&nbsp: Press Alt+s &nbsp</p4></center>';
         var Help_Info6b = '<center><p4>  Show Window (big)&nbsp: Press Alt+d &nbsp&nbsp</p4></center>';
         var Help_Info7 = '<center><p4>  Hide Window&nbsp: Press Alt+x &nbsp&nbsp&nbsp&nbsp</p4></center>';
         var Help_Info8 = '<center><p4>  原文、聽NKJV&nbsp: 需有Internet &nbsp</p4></center>';
         var Help_Info9 = '<center><p4>  顯示原文&nbsp: Press Alt+o Or Click 原&nbsp&nbsp&nbsp&nbsp</p4></center>';
         var Help_Info10a = '<center><p4>  顯示查詢輸入視窗&nbsp: Press Alt+f &nbsp</p4></center>';
         var Help_Info10b = '<center><p4>  聽NKJV&nbsp: Press Alt+l &nbsp</p4></center>';

         var Help_Info11a = '<center><p4>  鍵盤輸入&nbsp: Book No(b) Chap(x) Vers(v) &nbsp</p4></center>';
         var Help_Info11b = '<center><p4>  鍵盤輸入&nbsp: Book縮寫 Chap(x) Vers(v) &nbsp&nbsp&nbsp</p4></center>';
         var Help_Info12 = '<center><p4>  Book縮寫&nbsp: 3個字母 or 2個字母+1個數字 &nbsp</p4></center>';
         var Help_Info13a = '<center><p4>  如:創(gen) 士(jug) 撒下(sa2) 歌(sos) 約拿(jon) &nbsp</p4></center>';
         var Help_Info13b = '<center><p4>  如:太(mt) 可(mk) 路(lk) 約翰(jn) 林後(co2)&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p4></center>';
         var Help_Info13c = '<center><p4>  如:腓(phi) 門(phm) 約翰ㄧ(jo1) 猶(jud) &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p4></center>';
         var Help_Info14 = '<center><p4>  原文、原文直譯(中文、英文解釋): Click 原 &nbsp</p4></center>';
         var Help_Info15 = '<center><p4>  原文、原文發音(英文解釋): 聽NKJV-> &nbsp&nbsp&nbsp</p4></center>';
         var Help_Info16 = '<center><p4>  &nbsp&nbspClick NKJV Audio Bible-> Tools->原文編號&nbsp</p4></center>';         
         

         docObj.writeln(Result_head.fontcolor(bcs_color));
         docObj.writeln(Result_line.fontcolor(bcs_color));
         docObj.writeln(Help_Info1);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info3);
         docObj.writeln(Help_Info4);
         docObj.writeln(Help_Info5);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info6a);
         docObj.writeln(Help_Info6b);
         docObj.writeln(Help_Info7);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info8);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info9);
         docObj.writeln(Help_Info10a);
         docObj.writeln(Help_Info10b);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info14);
         docObj.writeln(Help_Info15);
         docObj.writeln(Help_Info16);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info11a);
         docObj.writeln(Help_Info11b);
         docObj.writeln(Help_Info12);
         docObj.writeln(Help_Info2);
         docObj.writeln(Help_Info13a);
         docObj.writeln(Help_Info13b);
         docObj.writeln(Help_Info13c);
...
//      else
      ...
      if (open_win_l==2){
         ...
         docObj.writeln('<li><a href="" onClick="Send_to_win34(5,' + findb+ ', ' + findchap+ ',' + findsec+ ',0 ,0 , 0 ); return false;">' + temp_S + '</a> ' + oneline_S + '</li>\n');
