...
function allowAny(t) {
  ...
  nowbook = 0;
  nowchapter = 0;
  for (i = 0; i < profiles2.length; i++) {    // modify on 20180910
    var oneline = profiles2[i];               // modify on 20180910
    var ok = false;
    var compareElement  = profiles2[i].toUpperCase();
...
function requireAll(t) {
  ...
  for (i = 0; i < profiles2.length; i++) {      // modify on 20180910
    ...
    var allString       = profiles2[i];             // modify on 20180910
