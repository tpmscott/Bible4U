...
function readchapter(bnum, cnum ,snum) {   // for window4, main2.html
  docObj.open();
  //docObj2.open();
  //docObj_h.open();
...
//      var bcsname2 = bname + ' 第' + cname + '篇' + ' 第' + sname + '節' + '</ol>';
      ...
      if(bname=='雅歌'){
         var bnameT = 'Song of Solomon';
      }
      else{
         var bnameT = bname;
      }

      var bcsname1 = bnameT + '  ' + '  Chapter  ' + cname + '' + '</ol>';
      var bcsname2 = bnameT + '  ' + '  Chapter  ' + cname + '' + '</ol>';
...
//      var oneline_1_3 = '<table><tr><td valign="top">'+'NIV'+'&nbsp&nbsp&nbsp&nbsp'+'</td><td valign="top">'+sj+'</td><td>'+oneline_3+'</td></tr></table>';
      ...
      if(cname==cname_1){
         ...
         //else{
            ...
            if(BibleVersion_Disp==0)
               docObj.writeln(oneline_1_2);  // NKJV

            if(BibleVersion_Disp==1)
               docObj.writeln(oneline_1_3);  // NIV

            if(BibleVersion_Disp==2)
               docObj.writeln(oneline_1_4);  // 呂振中譯本

            if(BibleVersion_Disp==3){        // NKJV & NIV

              var oneline_1_2_v = '<table><tr><td valign="top">'+ 'NKJV' +'</td></tr></table>';
              docObj.writeln(oneline_1_2_v);
              docObj.writeln(oneline_1_2);  

              var oneline_1_3_v = '<table><tr><td valign="top">'+ 'NIV' +'</td></tr></table>';
              docObj.writeln(oneline_1_3_v);
              docObj.writeln(oneline_1_3);
